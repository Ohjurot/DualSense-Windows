...
DS5W_API DS5W::Color DS5W::color_R32G32B32_UNORM(float r, float g, float b) {
	return {(unsigned char)(255.0F * r), (unsigned char)(255.0F * g), (unsigned char)(255.0F * b)};
}

DS5W_API DS5W::Color DS5W::color_R32G32B32A32_UNORM(float r, float g, float b, float a) {
...
DS5W_API DS5W::Color DS5W::color_R8G8B8_UCHAR_A32_UNORM(unsigned char r, unsigned char g, unsigned char b, float a) {
